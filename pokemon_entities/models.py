...
class Pokemon(models.Model):
    ...
    image = models.ImageField(null=True, blank=True, verbose_name="картинка покемона")
    description = models.TextField(blank=True, verbose_name="описание покемона")
    previous_evolutions = models.ForeignKey("self", on_delete=models.CASCADE, null=True, blank=True, related_name='next_evolutions', verbose_name="Эволюция")
